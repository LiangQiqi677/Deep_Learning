...
plt.plot(train_loss_d ,label='DilatedConv',color='blue')
plt.plot(train_loss_c ,label='Conv', color='orange')
...
plt.plot(test_loss_d ,label='DilatedConv',color='blue')
plt.plot(test_loss_c ,label='Conv', color='orange')
...
plt.plot(train_acc_d ,label='DilatedConv',color='blue')
plt.plot(train_acc_c ,label='Conv', color='orange')
...
plt.plot(test_acc_d ,label='DilatedConv',color='blue')
plt.plot(test_acc_c ,label='Conv', color='orange')
plt.ylabel("test_acc")
plt.xlabel("epoch")
plt.title("test_acc")
plt.legend()
